    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <svg
              className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-pink-600"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-pink-500 transition-all"
...
const MembersManager = ({ members, onCreate, onEdit, onDelete, isLoading }) => {
    ...
    try {
      if (editingMember) {
        ...
        if (profileImageFile && savedMember?.id) {
          ...
          if (imageUrl) {
            // Update member with image URL - pass all fields
            await onEdit(savedMember.id, { 
              ...formData,
  ...
  const handleToggleStatus = async (member) => {
    try {
      ...
      // Refresh the members list by calling parent's edit with full member data
