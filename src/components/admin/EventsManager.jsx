...
const EventsManager = ({ events, onSave, onDelete, isLoading }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await onSave(formData, Boolean(editingId), editingId);
    resetForm();
  };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-5 py-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:ring-4 focus:ring-sharda-blue/10 focus:border-sharda-blue transition-all font-medium text-lg"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full px-5 py-3.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:border-sharda-blue appearance-none font-medium"
                      >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-5 py-3.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:border-sharda-blue"
                    />
                  </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="flex gap-4">
                      <div className="w-16 h-16 rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center overflow-hidden shrink-0">
                        {formData.image_url ? (
                          <img
                      ...
                      <input
                        ...
                        className="flex-1 px-5 py-3.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:border-sharda-blue"
                      />
                    </div>
                    <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                      Tip: use a direct image URL (ends with .jpg/.png/.webp) or
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-5 py-3.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:border-sharda-blue min-h-[120px]"
                    />
                  </div>
                </div>
              </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                            <div className="md:col-span-5">
                              <input
                                ...
                                className="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800 border-transparent focus:bg-white dark:focus:bg-gray-900 focus:ring-2 focus:ring-sharda-blue/20 outline-none text-sm font-medium"
                              />
                            </div>
                            <div className="md:col-span-3">
                              <input
                                ...
                                className="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800 border-transparent focus:bg-white dark:focus:bg-gray-900 focus:ring-2 focus:ring-sharda-blue/20 outline-none text-sm"
                              />
                            </div>
                            <div className="md:col-span-2">
                              <input
                            ...
                            <div className="md:col-span-2">
                              <select
                                ...
                                className="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800 border-transparent focus:bg-white dark:focus:bg-gray-900 focus:ring-2 focus:ring-sharda-blue/20 outline-none text-xs font-bold uppercase"
                              >
                      ...
                      {formData.themes.map((theme, index) => (
                        <div key={index} className="flex gap-2 group">
                          <input
                            ...
                            className="flex-1 px-5 py-3 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-sm outline-none focus:border-purple-500"
                          />
                          <button
                            type="button"
                      ...
                      {formData.prizes.map((prize, index) => (
                        ...
                        >
                          ...
                          <input
                            ...
                            className="flex-[2] px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800 border-transparent focus:bg-white dark:focus:bg-gray-900 outline-none text-sm"
                          />
                          <button
                            type="button"
