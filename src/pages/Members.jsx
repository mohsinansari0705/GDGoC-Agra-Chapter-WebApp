  ...
  const MemberCard = ({ member, isLarger = false }) => (
    ...
    >
      ...
      <div className="p-8 text-center relative z-10">
        ...
        <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wider">
          {getPositionLabel(member.position)}
        </p>
        <p className="text-xs text-gray-400 dark:text-gray-500 mb-6 break-all px-4">
          {member.email}
        </p>
        ...
        <div className="flex justify-center gap-3 opacity-80 group-hover:opacity-100 transition-opacity">
          ...
          {member.instagram_url && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2.5 bg-gray-50 dark:bg-gray-700/50 text-gray-600 dark:text-gray-300 rounded-full hover:bg-gradient-to-tr hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7] hover:text-white transition-all duration-300 hover:scale-110 shadow-sm"
      ...
      <section className="relative overflow-hidden bg-white dark:bg-gray-900 pt-32 pb-20 px-4 sm:px-6 lg:px-8 border-b border-gray-100 dark:border-gray-800 z-10">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            innovation at GDG on Campus Sharda University Agra.
          </motion.p>
        </div>
      </section>
            ...
            {teamsArray.map((team) => (
              <section key={team.teamName} className="mb-20">
                ...
                <div className="flex items-center justify-center mb-8">
                  <div className="h-px bg-gray-200 dark:bg-gray-800 flex-grow mr-6"></div>
                  <motion.h2
